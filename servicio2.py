...
log_level = "DEBUG"
message = "Este es un mensaje de depuracion"

# URL del servidor central donde se enviarán los logs
url = "http://localhost:5001/logs"  # Esto es temporal; la URL real dependerá de tu servidor
...
while True:
    ...
    # Esperar 1 minutos (60 segundos) antes de enviar el siguiente log
    time.sleep(60)
